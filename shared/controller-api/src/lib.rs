...
pub use resources::{
    ...
    VmMigrationReason, VmMigrationSpec, VmMigrationStatus, VmPhase, VmPhaseKind, VmReason, VmSpec,
    VmStatus, Volume, VolumeAttachmentStatus, VolumeMode, VolumePhase, VolumePhaseKind,
    VolumeReason, VolumeSnapshot, VolumeSnapshotPhase, VolumeSnapshotPhaseKind,
