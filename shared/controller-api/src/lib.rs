...
pub use resources::{
    ...
    ImagePhaseKind, ImageSpec, ImageStatus, IssuedCertificate, LABEL_CLOUD_UID, LABEL_MANAGED_BY,
    ...
    RoutedSubnet, RoutedSubnetSpec, RoutedSubnetStatus, Router, RouterPhaseKind, RouterSpec,
    RouterStatus, RunStrategy, SIGNER_USER_CLIENT, Secret, SecretSpec, StayReason, StayingVm,
    StoragePool, StoragePoolPhaseKind, StoragePoolSpec, StoragePoolStatus, Tenant, TenantQuota,
    ...
    VmMigrationPhaseKind, VmMigrationSpec, VmMigrationStatus, VmPhaseKind, VmSpec, VmStatus,
    Volume, VolumeAttachmentStatus, VolumeMode, VolumePhaseKind, VolumeSnapshot,
    VolumeSnapshotPhaseKind, VolumeSnapshotSpec, VolumeSnapshotStatus, VolumeSpec, VolumeStatus,
    accepts_class, cluster_accepts, frozen_vm_shape, grows_only, live_migration_refusal,
    new_volume, new_volume_snapshot, same_tenancy, second_open_is_a_migration, unbind_only,
    vm_shape_unchanged,
};
pub use rest::{
